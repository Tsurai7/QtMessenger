...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAuthWindowENDCLASS_t qt_meta_stringdata_CLASSAuthWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 14),  // "userRegistered"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 4),  // "User"
        QT_MOC_LITERAL(32, 4),  // "user"
        QT_MOC_LITERAL(37, 21)   // "onSignUpButtonClicked"
    },
    "AuthWindow",
    "userRegistered",
    "",
...
void AuthWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AuthWindow::*)(const User & );
            if (_t _q_method = &AuthWindow::userRegistered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AuthWindow::userRegistered(const User & _t1)
{
